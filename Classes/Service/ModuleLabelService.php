...
final readonly class ModuleLabelService
{
    ...
    private const LABEL_IDS = [
        ...
        'findings.rule.potentially_vague_interactive_label'.
        'findings.rule.symbol_only_label',
        'findings.rule.repeated_generic_label',
        'findings.rule.generic_label_different_targets',
        'findings.label',
